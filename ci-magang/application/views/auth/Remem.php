                    ...
                    <div class="col s12 m6 l5 offset-l4 offset-m2">
                        <div class="card white darken-1">
                            <div class="card-content ">
                                <span class="card-title">Sign Up Member</span>
                                <div class="row">
                                    <form class="col s12" method="post" action="<?= base_url('Auth/Remem'); ?>">
                                        <div class="input-field col s12">
                                            <input name="id_mem" id="id_mem" type="text" value="<?= $id_mem; ?>" readonly class="validate">
                                            <label for="id_mem">ID Member</label>
                                        </div>
                                        <div class="input-field col s12">
                                        ...
                                        <div class="input-field col s12">
                                            <select class="js-states browser-default" name="id_sub" abindex="-1" style="width: 100%" id="basic">
                                                <optgroup label="Subkategori" style="font:bold;">
                                                    <?php foreach ($sub_kategori as $su) : ?>
                                                        <option value="<?= $su['id_sub']; ?>"><?= $su['nama_sub']; ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                        <div class="input-field col s12">
                                            <select class="js-states browser-default" name="id_lok" abindex="-1" style="width: 100%" id="basic">
                                                <optgroup label="Lokasi" style="font:bold;">
                                        ...
                                        <div class="input-field col s12">
                                            <textarea name="alamat" id="alamat" class="materialize-textarea" value="<?= set_value('alamat'); ?>" length="120" style="height: 21.2px;"></textarea>
